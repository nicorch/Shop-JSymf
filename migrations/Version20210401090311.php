 ...
 */
final class Version20210401090311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, date_created DATETIME NOT NULL, date_edited DATETIME DEFAULT NULL, total DOUBLE PRECISION NOT NULL, taxes DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
